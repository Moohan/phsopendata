...
In this example, we are downloading General Practitioner Contact Details from: [opendata.nhs.scot/dataset/*general-practitioner-contact-details*](https://www.opendata.nhs.scot/dataset/general-practitioner-contact-details), so the dataset name will be general-practitioner-contact-details.

...
get_dataset <- function(
  ...
  # This base R approach is much more performant than the original
  # tidyverse implementation. It avoids creating intermediate tibbles.
  ...
  # 3. Find which column names have more than one unique type.

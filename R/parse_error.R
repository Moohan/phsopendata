#' Generates error message from an "error" element of an `httr2::resp_body_json` object
#'
#' @param error The "error" element of an object produced by `httr2::resp_body_json`.
